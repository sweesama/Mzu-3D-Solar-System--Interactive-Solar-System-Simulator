(function (root) {
    ...
    const stations = Object.freeze([
        Object.freeze({ x: 0, z: 100, y: 130, yaw: 0.5, pitch: -0.05 }),    // 01 approach, high view of the thin rings facing Uranus
        Object.freeze({ x: 40, z: -410, y: 10, yaw: 0.35, pitch: -0.02 }),  // 02 inside the ε ring — the brightest band
        Object.freeze({ x: -50, z: -140, y: 6, yaw: -1.7, pitch: 0.02 })    // 03 in the dark gap between narrow rings
    ]);
    const discoveries = Object.freeze([
        Object.freeze({ id: 'approach', x: 0, z: 100, radius: 30, node: 1, markerHeight: 126, y: 126 }),
        Object.freeze({ id: 'epsilon', x: 40, z: -410, radius: 12, node: 4, markerHeight: 8, y: 9 }),
        Object.freeze({ id: 'gap', x: -50, z: -140, radius: 30, node: 7, markerHeight: 7, y: 6 }),
        Object.freeze({ id: 'shepherd', x: -160, z: 240, radius: 26, node: 3, markerHeight: 12, y: 10 }),
        Object.freeze({ id: 'tilt', x: 150, z: 60, radius: 24, node: 6, markerHeight: 16, y: 14 })
    ]);
    const nodes = Object.freeze([
        { x: 0, z: 100 }, { x: -30, z: 140 }, { x: -100, z: 190 }, { x: -160, z: 240 },
        { x: 40, z: -410 }, { x: 20, z: -250 }, { x: 150, z: 60 }, { x: -50, z: -140 }
    ].map(Object.freeze));
    const edges = Object.freeze([[0, 1], [1, 2], [2, 3], [0, 5], [5, 4], [0, 6], [5, 7]].map(Object.freeze));
    ...
    root.UranusExpedition = Object.freeze({ STORAGE_KEY: 'mzu-uranus-rings-v1', stations, discoveries, nodes, edges, isOnRoute, canDiscover, parseProgress, recordDiscovery, guidance });
