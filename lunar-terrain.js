(function (root) {
    ...
    const craters = [
        { x: 0, z: -42, radius: 48, depth: 12, rim: 5.5 },
        { x: -127, z: 95, radius: 27, depth: 6, rim: 2.8 },
        { x: 145, z: -128, radius: 75, depth: 18, rim: 7 },
        { x: -210, z: -198, radius: 110, depth: 23, rim: 9 },
        { x: 210, z: 182, radius: 38, depth: 8, rim: 3.6 },
        { x: 62, z: 119, radius: 9, depth: 2, rim: 0.8 },
        { x: -54, z: 24, radius: 8, depth: 1.7, rim: 0.8 },
        { x: 80, z: -17, radius: 15, depth: 3.2, rim: 1.4 }
    ];
    ...
    function height(x, z) {
        let h = (noise(x * 0.008 + 7, z * 0.008 + 12) - 0.5) * 15;
        h += (noise(x * 0.034, z * 0.034) - 0.5) * 2.8;
        h += (noise(x * 0.13, z * 0.13) - 0.5) * 0.65;
        h += (noise(x * 0.45, z * 0.45) - 0.5) * 0.16;
