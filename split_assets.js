...
// Use indexOf to avoid Regex Catastrophic Backtracking on large strings
...
// Find the LAST and LARGEST <script> block
// We know the main script is near the end, right before window.onload or it IS the one with window.onload
